        ...
        <div class="content mt-3">
            ...
            <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <form action="model/user.php?model=tambah" method="post"/>
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="mediumModalLabel">Tambah Data User</h5>
                            ...
                            <div class="form-group">
                                <label for="company" class=" form-control-label">Ulangi Password</label>
            ...
            <div class="col-sm-12">
                <div class="alert  alert-success alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-success">Berhasil</span> Anda Berhasil Menambah Data User <strong><?= $_GET['id']; ?></strong>.
          ...
          <?php  }
            ...
            <?php  }
            else if($_GET['status'] == "tambahGagal2"){ ?>
            <div class="col-sm-12">
                <div class="alert  alert-danger alert-dismissible fade show" role="alert">
                    <span class="badge badge-pill badge-danger">Gagal</span> Password tidak sama
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['username']; ?></td>
                                            <td>
                                            <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit<?= $row['username']; ?>"><i class="fa fa-pencil" ></i>&nbsp; Ubah</button>&nbsp;
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?= $row['username']; ?>"><i class="fa fa-trash" ></i>&nbsp; Hapus</button>
                                          
                                            </td>
                                            <div class="modal fade" id="hapus<?= $row['username'] ?>" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-sm" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>
                                                                Apakah Anda ingin menghapus Username <strong><?= $row['username'] ?></strong> ?
                                                            </p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak</button>
                                                            <a href="model/user.php?model=hapus&username=<?= $row['username'];?>" class="btn btn-primary">Ya</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            
                                            <div class="modal fade" id="edit<?= $row['username']; ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-lg" role="document">
                                                <form action="model/user.php?model=edit&id=<?= $row['id'];?>" method="post"/>
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="mediumModalLabel">Tambah Data User</h5>
                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="company" class=" form-control-label">Username</label>
                                                        <input type="text" id="username" name="username" placeholder="Masukan Username" value="<?= $row['username']; ?>" class="form-control">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="company" class=" form-control-label">Password</label>
                                                        <input type="password" id="password" name="password" placeholder="Masukan Password" class="form-control">
